...
class StudentSignup extends Component {
  ...
  enrollStudent = (id, title) =>
    this.props.changeStudentModalVisibility(true, id, title, this.getProjects);
        ...
        <Row justify="center" id="student-signup-section">
          ...
          <Col xs={12} md={signupProjectView ? 4 : 3}>
            ...
            <input
              ...
              className={
                'input' +
                this.getValidationClass(isValidated.filterValue) +
          ...
          {!signupProjectView ? (
            <Col xs={12} md={6}>
              {selectedSemester.value ? (
                  ...
                  {filteredStudents.length ? (
                    <div className="project-list-wrapper">
                      ...
                      <div style={{ textAlign: 'center' }}>
                        <Button
                          onClick={() =>
                            this.setState({ signupProjectView: true })
                          }
                        >
                    ...
                    >
                      <img
                        style={{ width: '100%' }}
                        src={require('../../Images/marginalia-delete-confirmation.svg')}
                        alt=""
                      />
                ...
                >
                  <img
                    style={{ width: '100%' }}
                    src={require('../../Images/marginalia-navigation-support.svg')}
                    alt=""
                  />
                </div>
              )}
            ...
            <>
              ...
              <Col xs={12} md={4}>
                ...
                <input
                  className={
                    'input' + this.getValidationClass(isValidated.email)
                  }
                  placeholder="Email"
                  onInput={e => {
              ...
              <Col xs={12} sm={12} md={4}>
                <div style={{ textAlign: 'center' }}>
                  ...
                  >
                    {isLoading ? <LoadingIcon /> : 'Sign up your project!'}
                  </button>
                </div>
              </Col>
            </>
