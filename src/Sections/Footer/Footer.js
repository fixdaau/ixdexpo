                ...
                <Row >
                    <Col xs={12} md={7}>
                        ...
                        <div className='description-text'>
                            ...
                            March 20th, 2020 <img style={{ marginLeft: '32px' }} src={require('../../Images/Icons_Time_White.svg')} alt=""/>13:00 - 19:00
                            </div>
                        <div className='large-text'>WHERE?</div>
                        <div className='description-text'>
                            <img className='footer-icon' alt='' src={require('../../Images/Icons_Location_White.svg')} />
