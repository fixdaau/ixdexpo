...
class InterestedCompanySection extends Component {
  ...
  addToFireBase = () => {
    ...
    setTimeout(() => this.setState({ isSubmitted: false }), 6500);
  };
    ...
    return (
      <Row id="interested-section">
        <Col xs={12} sm={12} md={5}>
          ...
          <form ref={el => (this.myFormRef = el)}>
            ...
            <input
              ...
              placeholder="Name"
              onInput={i => {
                this.updateMainPayload('name', i.target.value);
            ...
            <input
              ...
              placeholder="Email"
              onInput={i => {
                this.updateMainPayload('email', i.target.value);
            ...
            {isSubmitted && (
              ...
              >
                Thank you for your interest, we will get in touch with an
                invitation!
              </div>
            )}
            <button
              ...
              disabled={
                !Object.keys(isValidated).every(k => isValidated[k] === 'valid')
              }
              onClick={e => {
                e.preventDefault();
                this.addToFireBase();
            ...
            >
              {isLoading ? <LoadingIcon /> : 'I’d like to sign up!'}
            </button>
          </form>
        </Col>
        <Col md={1} />
        <Visible xs={false} sm={false} md={false} lg={true} xl={true}>
          <Col md={6}>
            <img src={require('../../Images/marginalia-success.svg')} alt="" />
          </Col>
        </Visible>
      </Row>
    );
