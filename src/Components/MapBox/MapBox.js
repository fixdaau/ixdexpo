...
import { MapboxProvider, MapGL, Layer, LoadImages, Control } from '@react-mapboxgl/core';
import './MapBox.scss';
        ...
        return (
            <div style={{ height: '100%', width: '100%' }} className='map-container'>
                <MapboxProvider accessToken='pk.eyJ1IjoidXNqIiwiYSI6ImNqb3R1Ym0xcTExejgzc25yN3FzZnp2djUifQ.30m9yrcu7he0TkJDapdQPA' >
                    <MapGL {...defaults} center={this.state.center} zoom={this.state.zoom}>
                ...
                <img className='flytoimage' src={require('../../Images/favicon-32x32.png')} alt=''
                    onClick={() => {
                        this.setState({
